...
namespace PcC_PartPicker
{
    ...
    public class Cpu
    {
        ...
        /// </summary>
        public double BaseClock { get; private set; }
        /// <summary>
        /// Maximum Frequency of CPU
        /// </summary>
        public double BoostClock { get; private set; }
        /// <summary>
        ...
        public Cpu(string brand, string model, int cores, int threads, double baseClock,double boostClock,
                   string socket, int tdp, int l3Cache, int maxmemfreq, bool unlocked, double price)
        {
            this.Brand = brand;
            this.Model = model;
            this.Cores = cores;
